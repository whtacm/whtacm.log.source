...
最近项目想整一个类似`客服`系统的东西，网上找了找，组长发了一个叫 `PPMessage` 的开源项目叫研究，拿来看一看。今天讲一下使用的情况，首先今天说一下如何搭建这个东西（其实在[`GitHub`](https://github.com/PPMESSAGE/ppmessage)上有说明，但是具体上步骤还是有些问题，就来简单讲一讲）。
<!--- more --->
